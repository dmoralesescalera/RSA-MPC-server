...
class Protocol:
	...
	def export_params(self):
		...
		if self.runtime.id == 1:
			args = 	"python file-writer.py values-1.txt" + " " + str(self.n_revealed) + " " + str(self.d)		
			p = Popen(args, shell=True)
			p.wait()

		elif self.runtime.id == 2:
			args = 	"python file-writer.py values-2.txt" + " " + str(self.n_revealed) + " " + str(self.d)		
			p = Popen(args, shell=True)
			p.wait()

		elif self.runtime.id == 3:
			args = 	"python file-writer.py values-3.txt" + " " + str(self.n_revealed) + " " + str(self.d)		
			p = Popen(args, shell=True)
			p.wait()
	...
	def export_public(self):
		...
		if self.runtime.id == 1:
			...
			args = "python pub_key_encoder.py " + str(self.n_revealed) + " " + str(self.e)
